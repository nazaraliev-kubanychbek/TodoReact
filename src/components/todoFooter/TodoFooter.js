    ...
    return (
        ...
        <div className="todoList__footer">
            ...
            <div className='todoList__footer-center'>
                <button type='button'
                        className={`todoList__footer-btn ${status === 'all' ? 'todoList__footer-btn-active' : ''}`}
                        value='all' onClick={(e) => changeStatus(e)}>All
                </button>
                <button type='button'
                        className={`todoList__footer-btn ${status === 'active' ? 'todoList__footer-btn-active' : ''}`}
                        value='active' onClick={(e) => changeStatus(e)}>Active
                </button>
                <button type='button'
                        className={`todoList__footer-btn ${status === 'completed' ? 'todoList__footer-btn-active' : ''}`}
